...
class BaseSynthesizer:
    ...
    def save(self, path):
        ...
        # Create a copy of the logger attribute
        logger_backup = self.logger
        train_z_tuple_backup =   self.train_z_tuple
        sample_z_tuple_backup =   self.sample_z_tuple

        
        # Set logger to None before saving
        self.logger = None
        self.train_z_tuple = None
        self.sample_z_tuple = None
        ...
        try:
            ...
            self.train_z_tuple = train_z_tuple_backup
            self.sample_z_tuple = sample_z_tuple_backup
            # Restore the device
            self.set_device(device_backup)
